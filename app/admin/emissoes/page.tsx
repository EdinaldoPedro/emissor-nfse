...
import { Search, Building2, Edit, Save, MapPin, Loader2 } from 'lucide-react';
    ...
    <div className="p-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
        <table className="w-full text-left text-sm">
            ...
            <tbody>
                {filtered.length === 0 ? (
                    <tr><td colSpan={4} className="p-8 text-center text-gray-400">Nenhuma empresa encontrada.</td></tr>
                ) : (
                    filtered.map(emp => (
